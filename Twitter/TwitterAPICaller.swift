...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "rde5iopAt5iUMr6yakAytEWkD", consumerSecret: "zGkcEK9GXR7bz406wxp8Yrw5kojbbs1HZd08rd7XYeAyuWShSf")
    var loginSuccess: (() -> ())?
